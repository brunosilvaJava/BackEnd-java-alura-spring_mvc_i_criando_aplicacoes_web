  ...
  <header id="layout-header">
	...
	<article id="${produto.idProduto}">
	  ...
	  <section class="buy-options clearfix">  
		  ...
		  <form action="<c:url value='/carrinho/adicionarProduto' />" method="post" class="container">
		    ...
		    <ul id="variants" class="clearfix">
		    	  <c:forEach items="${produto.precos}" var="preco">
				    <li class="buy-option">
				        ...
				        <input type="radio" name="idProduto" class="variant-radio" id="" value="9720393823"  checked="checked"  />
			...
			<div id="social-footer">
				...
				<ul>
					<li class="social-links">
						<a id="twitter" href="http://www.twitter.com/casadocodigo" target="_blank" rel="nofollow">Facebook</a>
						<a id="facebook" href="http://www.facebook.com/casadocodigo" target="_blank" rel="nofollow">Twitter</a></li>
				</ul>
			</div>
