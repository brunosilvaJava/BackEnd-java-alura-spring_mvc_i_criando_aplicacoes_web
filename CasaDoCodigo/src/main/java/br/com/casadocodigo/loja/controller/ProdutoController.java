...
public class ProdutoController {
	...
	public ModelAndView initIncluirProduto(Produto produto) {
		...
		ModelAndView modelAndView = new ModelAndView(UtilPages.INCLUIR_PRODUTO);
	...
	public ModelAndView gravarProduto(MultipartFile sumario, @Valid Produto produto, BindingResult result, RedirectAttributes redirectAttributtes) {
		...
		return new ModelAndView(UtilPages.LISTAR_PRODUTOS_REDIRECT);
	...
	public ModelAndView listar() {
		...
		ModelAndView modelAndView = new ModelAndView(UtilPages.LISTAR_PRODUTOS);
	...
	@RequestMapping("/detalharProduto/{idProduto}")
	public ModelAndView detalharProduto(@PathVariable("idProduto") Integer idProduto){
		
	    ModelAndView modelAndView = new ModelAndView(UtilPages.DETALHAR_PRODUTO);
	    modelAndView.addObject("produto", produtoBO.consultarProduto(idProduto));
